...
@section('title', 'Admin Hero Page Dashboard - Hero Page Create')
@section('content')
    ...
    <div class="nav">
        <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
            <div class="d-flex justify-content-start align-items-center">
                ...
                <h2 class="nav-title">
                    <a href="#">Hero Page Create Form</a>
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-12 statistics-card">
                <form action="{{ route('admin.heroPage.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
