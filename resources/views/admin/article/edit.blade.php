...
@section('title', 'Admin Article Dashboard - Article Edit')
@section('content')
                ...
                <form action="{{ route('admin.article.update', $article) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $article) }}" />
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select">
                                       ...
                                       @foreach ($categories as $category)
                                        ...
                                        @if (old('category_id') == $category->id || $category->id == $article->category_id)
                                            selected
