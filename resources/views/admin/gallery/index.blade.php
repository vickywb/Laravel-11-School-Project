...
@section('title', 'Admin Gallery Dashboard')
@section('content')
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between">
                <h2 class="content-title mb-4">List Gallery</h2>
                <div class="btn mb-2 mb-md-0">
                    <a href="{{ route('admin.gallery.create') }}" class="btn btn-sm btn-primary"> Add new</a>
                </div>
            </div>
                                    ...
                                    <td width="10%">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                                                <li>
                                                    <a
                                                        href="{{ route('admin.gallery.detail', $gallery) }}"
                                                ...
                                                <li>
                                                    <form action="{{ route('admin.gallery.delete', $gallery) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button
