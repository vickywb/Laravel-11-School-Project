...
@section('title', 'Admin Major Dashboard')
@section('content')
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between">
                <h2 class="content-title mb-4">List Major</h2>
                <div class="btn mb-2 mb-md-0">
                    <a href="{{ route('admin.major.create') }}" class="btn btn-sm btn-primary"> Add new</a>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                 ...
                                 <tr>
                                    <td>{{ Str::ucfirst($major->title) }}</td>
                                    <td>{!! Str::words($major->description, 20, '...') !!}</td>
                                    <td><img src="{{ $major->file->showFile ?? asset('noimage/no-image.png') }}" alt="major-image" width="50px" height="50px"></td>
                                    <td width="10%">
                                        <div class="dropdown">
                                            <button
